...
//
    ...
    public static void renderRectBlur(float x,float y,float width,float height,int stencilFrameBufferTexture, int iterations, float offset) {
        ...
        int x_ = (int) (x * Minecraft.getInstance().getMainWindow().getGuiScaleFactor()),
                y_ = (int) ((int)(Minecraft.getInstance().getMainWindow().getHeight() - (height * Minecraft.getInstance().getMainWindow().getGuiScaleFactor())) - (y * Minecraft.getInstance().getMainWindow().getGuiScaleFactor()));
...
//        GlStateManager.disableBlend();
        ...
        GL11.glScissor(x_ ,y_, (int) (width * mc.getMainWindow().getGuiScaleFactor()), (int) (height * mc.getMainWindow().getGuiScaleFactor()));
        ...
        com.mojang.blaze3d.platform.GlStateManager.bindTexture(0);
