 ...
 */
package info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase;
...
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.model.ComparableProtocolVersion;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.model.Platform;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.ViaBackwardsPlatformImpl;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.ViaRewindPlatformImpl;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.ViaVersionPlatformImpl;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.viaversion.VLBViaCommandHandler;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.viaversion.VLBViaInjector;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.platform.viaversion.VLBViaProviders;
import info.sigmaclient.sigma.sigma5.jelloportal.florianmichael.vialoadingbase.util.JLoggerToLog4j;
    ...
    public void initPlatform() {
        ...
        manager.addEnableListener(() -> {
            for (Platform platform : this.platforms)
                platform.build(ViaLoadingBase.LOGGER);
        });
