...
//              }
     ...
     * @throws IllegalArgumentException if the volume is not in interval [0..100]
     */
     ...
     * the play list.
     *
     * @param shuffle true if shuffle should be turned on, or false for turning off
     */
     ...
     *
     * @param repeat true if repeat should be turned on, or false for turning off
     */
