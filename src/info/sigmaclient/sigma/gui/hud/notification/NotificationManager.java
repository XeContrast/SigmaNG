...
public class NotificationManager {
	...
	public void onRender(){
		...
		睬䬾ใ蓳唟 = 5;
		埙玑蚳葫褕 = 5;
		塱揩㢸樽竁 = SigmaNG.gameMode == SigmaNG.GAME_MODE.JELLO ? 200 : 50;
		쇽뫤쿨曞值 = SigmaNG.gameMode == SigmaNG.GAME_MODE.JELLO ? 32 : 32;
		䡸㐖퉧붛韤 = SigmaNG.gameMode == SigmaNG.GAME_MODE.JELLO ? 340 / 2 : 120;
