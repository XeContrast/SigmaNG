...
public class Backtrack extends PremiumModule {
    ...
    public Backtrack() {
        super("Backtrack", Category.Misc, "Backtrack. (killaura only & better)");
    ...
    public void clear() {
        ...
        if (mc.getConnection() != null)
            serverPackets.forEach((e) -> {
                    ...
                    SigmaNG.getSigmaNG().eventManager.call(packetEvent);
                try {
    ...
    public void onUpdateEvent(UpdateEvent event){
        ...
        if(delayTicks > 0){
            ...
            for(Entity entity : mc.world.getLoadedEntityList()){
                ...
                if(((Killaura)SigmaNG.getSigmaNG().moduleManager.getModule(Killaura.class)).isTargetEnable((LivingEntity) entity)){
...
//            }
//        }
        if (event.packet instanceof SEntityPacket packet) {
