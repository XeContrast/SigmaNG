...
import info.sigmaclient.sigma.modules.gui.hide.KeyBindManagerUI;
import info.sigmaclient.sigma.modules.gui.hide.SnakeUI;
...
public class ModuleManager {
    ...
    public CopyOnWriteArrayList<Module> SpaceModules = new CopyOnWriteArrayList<>();
    ...
    public void registerModule(Module module){
        ...
        if(module.isSpecialGUI()){
            SpaceModules.add(module);
        }
        modules.add(module);
...
//        }
        ...
        registerModule(new KeyBindManagerUI());
        registerModule(new SnakeUI());
