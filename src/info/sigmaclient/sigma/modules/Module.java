...
public class Module extends EventBase{
    protected boolean SpecialGUI = false;
    ...
    public void onChangeStatus() {
        if(enabled){
            this.onEnable();
            SigmaNG.getSigmaNG().SigmaNG.getSigmaNG().eventManager.register(this);
        }else {
            this.onDisable();
            SigmaNG.getSigmaNG().SigmaNG.getSigmaNG().eventManager.unregister(this);
        }
    }
