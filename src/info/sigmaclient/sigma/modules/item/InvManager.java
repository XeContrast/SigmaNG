...
public class InvManager extends Module {
    ...
    private final BooleanValue onlyWhileNotMoving = new BooleanValue("Only while not moving", false);
    ...
    private final BooleanValue swapBlocks = new BooleanValue("Swap blocks", false);
    private final BooleanValue dropFood = new BooleanValue("No food", false);
    ...
    public boolean isBadItem(ItemStack stack, int slot, boolean stealing) {
        ...
        if (stealing || (slot != weaponSlot || !isBestWeapon(ItemType.WEAPON.getStackInSlot()))
            ...
            if ((item == Items.WHEAT) || item instanceof SpawnEggItem
                ...
                return true;
            } else if (!(item instanceof SwordItem) && !(item instanceof ToolItem) && !(item instanceof ArmorItem)) {
