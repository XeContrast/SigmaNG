...
//    private final BooleanValue fix = new BooleanValue("Fix ViaVersion", true);
    ...
    private final BooleanValue instantly = new BooleanValue("instantly",false);
    ...
    public void onWindowUpdateEvent(WindowUpdateEvent e) {
        ...
        if (mc.player != null && mc.player.openContainer instanceof ChestContainer chest) {
            if(instantly.isEnable()) {
                mc.timer.setTimerSpeed(2f);
            }
