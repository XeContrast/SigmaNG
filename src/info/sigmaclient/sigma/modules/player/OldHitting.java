...
//                translate(0.0, n * -0.2f, 0.0);
            ...
            case "Tap2":
                ...
                break;
            case "Leaked":
                translate(0.56, -0.52, -0.72, matrixStack);
                translate(0.0, equippedProgress * -0.6f, 0.0, matrixStack);
                rotate(77.0f, 0.0f, 1.0f, 0.0f, matrixStack);
                rotate(-10.0f, 0.0f, 0.0f, 1.0f, matrixStack);
                rotate(-80.0f, 1.0f, 0.0f, 0.0f, matrixStack);
                rotate(f1 * 10.0f, -4.0f, -2.0f, 5.0f, matrixStack);
                rotate(f1 * 30.0f, 1.0f, -0.0f, -1.0f, matrixStack);
...
//     registerValue(rotateS);
    ...
    public static float getRotateDirection() {
        rotateDirection = rotateDirection +  5;
