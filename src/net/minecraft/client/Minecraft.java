...
//                        this.player.swingArm(Hand.MAIN_HAND);
    ...
    {
        SigmaNG.getSigmaNG().eventManager.call(new MouseClickEvent(true));
...
//                this.player.swingArm(Hand.MAIN_HAND);
    ...
    public void rightClickMouse()
    {
        ...
        SigmaNG.getSigmaNG().eventManager.call(clickEvent);
    ...
    public void runTick()
    {
        SigmaNG.getSigmaNG().eventManager.call(new WindowUpdateEvent());
        ...
        SigmaNG.getSigmaNG().eventManager.call(new ClickEvent());
        boolean pause = Backtrack.publicFreeze && ((Backtrack)SigmaNG.getSigmaNG().moduleManager.getModule(Backtrack.class)).betterAnimation.isEnable();
    ...
    {
        SigmaNG.getSigmaNG().eventManager.call(new WorldEvent());
    ...
    {
        return (entity.isGlowing() || this.player != null && this.player.isSpectator() && this.gameSettings.keyBindSpectatorOutlines.isKeyDown() && entity.getType() == EntityType.PLAYER) && (!SigmaNG.getSigmaNG().inGameGuiBlur);
    }
