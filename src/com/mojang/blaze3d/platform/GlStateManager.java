...
public class GlStateManager
{
    ...
    public static void disableAlphaNoLock()
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        ALPHA_TEST.test.disable();
    }

    public static void enableAlphaNoLock()
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        ALPHA_TEST.test.enable();
    }
    public static void disableBlendNoLock()
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        BLEND.blend.disable();
    }

    public static void enableBlendNoLock()
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        BLEND.blend.enable();
    }
    ...
    public static void blendFuncSeparateNoLock(int srcFactor, int dstFactor, int srcFactorAlpha, int dstFactorAlpha) {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
